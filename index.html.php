    ...
    <section class="py-20 px-20 about-me-section">
        <div class="bg-white rounded-lg shadow-md p-6 flex about-me">
            ...
            <div class="flex-none text-center about-me-profile">
                <img class="rounded-full mx-auto mb-4 object-cover" style="height: 50%;aspect-ratio: 1 / 1;object-position: bottom;" src="./content/20240723_151152.jpg" alt="Patrick Grygoruk">
